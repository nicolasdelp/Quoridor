...
public class NoMoreWallsTest {
    ...
    public void testVerify1(){
        ...
        try {
            ...
            b.setWallOnBoard(b.players[0], b.players[0].getWalls()[b.players[0].getWallIndex()], WallDirection.Horizontal, new Position(1,3));
            b.setWallOnBoard(b.players[0], b.players[0].getWalls()[b.players[0].getWallIndex()], WallDirection.Horizontal, new Position(1,5));
            b.setWallOnBoard(b.players[0], b.players[0].getWalls()[b.players[0].getWallIndex()], WallDirection.Horizontal, new Position(1,7));
            b.setWallOnBoard(b.players[0], b.players[0].getWalls()[b.players[0].getWallIndex()], WallDirection.Horizontal, new Position(1,9));
