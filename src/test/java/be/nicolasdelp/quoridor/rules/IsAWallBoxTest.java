...
public class IsAWallBoxTest {
    ...
    public void testVerify1(){
        ...
        Assertions.assertThrows(RuleViolated.class, () -> {
            playerRule.verify(b, b.players[0], new Position(1, 8));
          });
    }
    ...
    public void testVerify2(){
        ...
        PlayerRule playerRule = new IsAWallBox();
        Assertions.assertThrows(RuleViolated.class, () -> {
            playerRule.verify(b, b.players[0], new Position(0, 7));
          });
    }
    ...
    public void testVerify3(){
        ...
        PlayerRule playerRule = new IsAWallBox();
        Assertions.assertThrows(RuleViolated.class, () -> {
            playerRule.verify(b, b.players[0], new Position(0, 9));
          });
    }
    ...
    public void testVerify4(){
        ...
        PlayerRule playerRule = new IsAWallBox();
        Assertions.assertThrows(RuleViolated.class, () -> {
            playerRule.verify(b, b.players[1], new Position(15, 8));
          });
    }
}