...
public class IllegalMovement implements PlayerRule, Serializable {
    ...
    public void verify(Board board, Player player, Position position) throws RuleViolated{
        ...
        if((position.getX() == player.getPawn().getPosition().getX()-2) && (position.getY() == player.getPawn().getPosition().getY()-2)){ //Si on va en haut à gauche
        ...
        if((position.getX() == player.getPawn().getPosition().getX()+2) && (position.getY() == player.getPawn().getPosition().getY()-2)){ //Si on va en haut à droite
        ...
        if((position.getX() == player.getPawn().getPosition().getX()-2) && (position.getY() == player.getPawn().getPosition().getY()+2)){ //Si on va en bas à gauche
        ...
        if(position.getX() == player.getPawn().getPosition().getX() && position.getY() == player.getPawn().getPosition().getY()-4){ //Si on va vers le haut de 2 cases
            ...
            if(position.getX() > player.getPawn().getPosition().getX()+3 || position.getX() < player.getPawn().getPosition().getX()-3
                || position.getY() > player.getPawn().getPosition().getY()+3 || position.getY() < player.getPawn().getPosition().getY()-3){ //Si on déplace de plus de 2 cases
                throw new RuleViolated(player, position, board, "Vous ne pouvez avancer que de 1 case a la fois !");
            }
        }
    }
