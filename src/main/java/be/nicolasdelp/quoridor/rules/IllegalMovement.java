    ...
    public void verify(Board board, Player player, Position position) throws RuleViolated{
        if(board.getBoardBoxes()[player.getPawn().getPosition().getX()][player.getPawn().getPosition().getY()+2].getisOccuped()){ //Si la case en haut est occupé par un pion
            if(board.getBoardBoxes()[player.getPawn().getPosition().getX()][player.getPawn().getPosition().getY()+3].getisOccuped()){ //Si il y a un mur derriere l'adversaire
                if((position.getX() != player.getPawn().getPosition().getX()-2 && position.getY() != player.getPawn().getPosition().getY()-2) || (position.getX() != player.getPawn().getPosition().getX()+2 && position.getY() != player.getPawn().getPosition().getY()-2) || (position.getX() != player.getPawn().getPosition().getX()-2 && position.getY() != player.getPawn().getPosition().getY()) || (position.getX() != player.getPawn().getPosition().getX()+2 && position.getY() != player.getPawn().getPosition().getY()) || (position.getX() != player.getPawn().getPosition().getX() && position.getY() != player.getPawn().getPosition().getY()+2)){ //Les 5 cases possibles
        ...
        if(board.getBoardBoxes()[player.getPawn().getPosition().getX()+2][player.getPawn().getPosition().getY()].getisOccuped()){ //Si la case à droite est occupé par un pion
            if(board.getBoardBoxes()[player.getPawn().getPosition().getX()+3][player.getPawn().getPosition().getY()].getisOccuped()){ //Si il y a un mur derriere l'adversaire
                if((position.getX() != player.getPawn().getPosition().getX()-2 && position.getY() != player.getPawn().getPosition().getY()+2) || (position.getX() != player.getPawn().getPosition().getX()-2 && position.getY() != player.getPawn().getPosition().getY()-2) || (position.getX() != player.getPawn().getPosition().getX() && position.getY() != player.getPawn().getPosition().getY()-2) || (position.getX() != player.getPawn().getPosition().getX()+2 && position.getY() != player.getPawn().getPosition().getY()) || (position.getX() != player.getPawn().getPosition().getX() && position.getY() != player.getPawn().getPosition().getY()+2)){ //Les 5 cases possibles
                    throw new RuleViolated(player, position, board, "Vous ne pouvez avancer que dans les cases à côté de votre adversaire !");
                }
            }
            else{ //Si il n'y a pas de mur derriere le pion adverse
